...
for j in range(677):
    k='%d' % (j+1)
    file='D:\\YUAN JC\\#top1#资讯管理学院\\2021-2022    大三图书馆学（上学期）\\科研训练\\科研训练txt\\3.smart libraties全文txt\\'+k+'.txt'
...
with open('C:\\Users\\yjc_2\\Desktop\\vosviewerfile3.txt','w',encoding='utf-8')as f:
    f.write(text)

wc=wordcloud.WordCloud(font_path='C:\\Windows\\Fonts\\arial.ttf',
                       background_color='white',
                       width=1000,
                       height=800,
                       )
wc.generate(text)
wc.to_file('D:\\YUAN JC\#top1#资讯管理学院\\2021-2022    大三图书馆学（上学期）\\科研训练\\wc3.jpg')
plt.imshow(wc)
plt.axis('off')
plt.show()